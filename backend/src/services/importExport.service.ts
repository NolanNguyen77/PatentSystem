  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    try {
      ...
      const patent = await prisma.patent.create({
        data: {
          titleId,
          documentNum: mappedData.bunken || mappedData.patentNo,
          applicationNum: mappedData.shutsugan,
          applicationDate,
          publicationDate,
          publicationNum: mappedData.kokai,
          registrationNum: mappedData.toroku,
          announcementNum: mappedData.kokoku,
          appealNum: mappedData.shinpan,
          // caseNo: mappedData.jiken, // ?
          // knownDate, // ?
          inventionTitle: mappedData.hatumei,
          applicantName: mappedData.shutsuganNin,
          // inventor: mappedData.hatumei?.split('/')[1] || null, 
          fiClassification: mappedData.ipc,
          // abstract: mappedData.abstract,
          statusStage: mappedData.stage,
          eventDetail: mappedData.event,
          otherInfo: mappedData.sonota,
